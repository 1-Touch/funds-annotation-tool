...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("img_name_submit").addEventListener("click", () => {
        // var img_name = document.getElementById("myText").value
        changePage("custom_img")
    })
...
function changePage(direction) {
    ...
    switch (direction) {
        ...
        case "previous":
            ...
            break
        case "custom_img":
            State.currentFileNumber=document.getElementById("img_name").value
            break
